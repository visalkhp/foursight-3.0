...
## Priority 12 note
The verified USB protocol is 9600 baud with newline-delimited commands S1 through S6 (and D for default terrain). Priority 12 changes are limited to the website decision interface; the working USB/Arduino layer is intentionally preserved.
